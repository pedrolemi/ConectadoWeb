...
export default class BedroomBase extends ConectadoBaseScene {
    ...
    */
    ...
    create(params) {
        ...
        // Interior de los armarios. Al hacer click sobre el interior del armario, se procesa el nodo 
        ...
        this.setInteractive("bedroomSmallWardrobe", this.smallWardrobeInside, () => {
            this.localizationManager.setNode(this.smallWardrobeNode);
        });
        ...
        this.setInteractive("bedroomBigWardrobe", this.bigWardrobeInside, () => {
            this.localizationManager.setNode(this.bigWardrobeNode);
        });


        // Ordenador
        this.pcNode = this.localizationManager.readNodes(this, this.everydayNodes, "everydayDialog", "bedroom.pc");

        // Al hacer click sobre el, se cambia procesa el nodo, y si se lanza el evento turnPC, se cambia a la escena del ordenador
        this.pc = this.add.zone(276, 360, 150, 162).setOrigin(0, 0);
        this.setInteractive("bedroomPC", this.pc, () => {
            this.localizationManager.setNode(this.pcNode);
        });
        ...
        // Cama
        this.bedNode = this.localizationManager.readNodes(this, this.everydayNodes, "everydayDialog", "bedroom.bedAfternoon");

        // Al hacer click sobre ella, se procesa el nodo
        ...
        this.setInteractive("bedroomBed", this.bed, () => {
            this.localizationManager.setNode(this.bedNode);
        });
