...
export default class AlarmScreen extends BaseScreen {
    ...
    */
    constructor(scene, phone, prevScreen) {
        ...
        let title = new TextArea(scene, this.BG_X, this.BG_Y * 0.4, this.bg.displayWidth, this.bg.displayHeight,
        ...
        new HourWidget(scene, this, this.BG_X, this.BG_Y * 0.55, this.bg.displayWidth, this.bg.displayHeight, this.DEFAULT_TEXT_CONFIG);

        
        // Icono del deslizable
        ...
        // Iconos de dormir/despertarse
        const ALARM_ICONS_SCALE = 0.2;
        const ICON_OFFSET_X = this.bg.displayWidth / 4 + 25;
        const ICON_POS_Y = this.BG_Y + 78;
